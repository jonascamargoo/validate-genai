...
# def calculate_textual_difference(response1, response2):
#     """Calculates a textual similarity ratio."""
#     return difflib.SequenceMatcher(None, response1, response2).ratio()

# textual_similarity = calculate_textual_difference(generated_response, expected_response)
# print(f"📏 Similaridade textual: {textual_similarity * 100:.2f}%")
